...
export default function Home() {
  ...
  return (
    <div className="space-y-10">
      ...
      <section className="space-y-6">
        <div>
          <h2 className="section-heading">Categor�as clave</h2>
      ...
      <section className="grid gap-6 lg:grid-cols-2">
        <GlassCard className="space-y-4">
          <Badge variant="neutral">Qui�nes somos</Badge>
        ...
        <GlassCard className="space-y-3">
          {[
            'Tiendas verificadas con informaci�n real y contacto directo.',
            'Categor�as enfocadas 100% en motociclistas.',
            'Compra simple y r�pida, sin procesos complejos.',
          ].map((item) => (
      ...
      <section>
        <GlassCard className="border-brand-500/30 space-y-4">
          ...
          <p className="text-sm text-white/60">
            Dise�a tu cat�logo, recibe pedidos y administra todo desde un panel premium.
          </p>
