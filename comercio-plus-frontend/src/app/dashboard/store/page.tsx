              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-3 rounded-2xl border border-slate-200 bg-slate-50 p-4 dark:border-white/10 dark:bg-slate-950/40">
                  ...
                  <label className="btn-secondary inline-flex cursor-pointer">
                    Subir logo
                    <input type="file" accept="image/*" onChange={(event) => onFileSelect(event, 'logo')} className="hidden" />
                  </label>
                ...
                <div className="space-y-3 rounded-2xl border border-slate-200 bg-slate-50 p-4 dark:border-white/10 dark:bg-slate-950/40">
                  ...
                  <label className="btn-secondary inline-flex cursor-pointer">
                    Subir portada
                    <input type="file" accept="image/*" onChange={(event) => onFileSelect(event, 'cover')} className="hidden" />
                  </label>
