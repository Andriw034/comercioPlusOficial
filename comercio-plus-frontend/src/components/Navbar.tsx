    ...
    <>
      ...
      >
        ...
        >
          {activeStore ? (
            <Link
              to={`/stores/${activeStore.slug}/products`}
              style={{
                display: 'flex',
                alignItems: 'center',
                gap: '10px',
            ...
            >
              ...
              <div style={{ lineHeight: 1.2 }}>
                <div style={{ fontWeight: 700, fontSize: '14px', color: '#111827', letterSpacing: '-0.2px' }}>
                  {activeStore.name}
                </div>
                <div style={{ fontSize: '10px', color: '#9ca3af', fontWeight: 400 }}>en ComercioPlus</div>
              </div>
            </Link>
          ) : (
            <Link
