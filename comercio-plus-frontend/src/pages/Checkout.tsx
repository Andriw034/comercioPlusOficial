...
export default function Checkout() {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const { init_point, orderId } = response.data

      if (!init_point) throw new Error('No se recibio URL de pago de MercadoPago')
              ...
              <div className="rounded-xl bg-green-50 p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-green-700">Protegido por MercadoPago y encriptacion SSL</p>
                  </div>
                </div>
              </div>
            </div>
