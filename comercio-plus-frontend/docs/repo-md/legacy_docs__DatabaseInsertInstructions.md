...
# GuÃƒÂ­a Completa para Insertar Datos en ComercioPlus

Esta guÃƒÂ­a proporciona comandos SQL completos para insertar datos de prueba en todas las tablas principales de la base de datos ComercioPlus.

## Ã¢Å¡Â Ã¯Â¸Â Importante: Orden de InserciÃƒÂ³n

Para respetar las claves forÃƒÂ¡neas, insertar los datos en este orden:
1. users
2. categories
3. stores
4. products
...
-- Usuario comerciante
INSERT INTO users (name, email, password, phone, status, address, role, created_at, updated_at)
VALUES ('MarÃƒÂ­a GonzÃƒÂ¡lez', 'maria@tienda.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '0987654321', 1, 'Av. Comercio 456', 'comerciante', NOW(), NOW());

-- Usuario cliente
INSERT INTO users (name, email, password, phone, status, address, role, created_at, updated_at)
VALUES ('Carlos RodrÃƒÂ­guez', 'carlos@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '1122334455', 1, 'Plaza Central 789', 'cliente', NOW(), NOW());
```
...
VALUES ('ElectrÃƒÂ³nica', 'Productos electrÃƒÂ³nicos y gadgets', 'electronica', NOW(), NOW());

INSERT INTO categories (name, description, slug, created_at, updated_at)
VALUES ('Ropa y Accesorios', 'Ropa, zapatos y accesorios de moda', 'ropa-accesorios', NOW(), NOW());

INSERT INTO categories (name, description, slug, created_at, updated_at)
VALUES ('Hogar y JardÃƒÂ­n', 'ArtÃƒÂ­culos para el hogar y jardÃƒÂ­n', 'hogar-jardin', NOW(), NOW());
...
```sql
-- Tienda de MarÃƒÂ­a GonzÃƒÂ¡lez (user_id = 2)
...
VALUES (2, 'TechStore', 'techstore', '/images/stores/techstore-logo.png', '/images/stores/techstore-cover.jpg', '#FF6B35', 'Tu tienda de tecnologÃƒÂ­a de confianza', 'Av. TecnologÃƒÂ­a 123, Ciudad', '555-0123', 'activa', 'Lunes a Viernes 9:00-18:00', 'ElectrÃƒÂ³nica', 4.8, NOW(), NOW());

-- Tienda adicional
INSERT INTO stores (user_id, name, slug, logo, cover, primary_color, description, direccion, telefono, estado, horario_atencion, categoria_principal, calificacion_promedio, created_at, updated_at)
VALUES (2, 'Fashion Corner', 'fashion-corner', '/images/stores/fashion-logo.png', '/images/stores/fashion-cover.jpg', '#8B5CF6', 'Moda y estilo para todos', 'Centro Comercial Plaza, Local 45', '555-0456', 'activa', 'Lunes a SÃƒÂ¡bado 10:00-20:00', 'Ropa y Accesorios', 4.6, NOW(), NOW());
```
...
VALUES ('iPhone 15 Pro', 'El ÃƒÂºltimo smartphone de Apple con chip A17 Pro', 1299.99, 15, '/images/products/iphone15.jpg', 1, 0, 4.9, 2, 1, NOW(), NOW());

INSERT INTO products (name, description, price, stock, image, category_id, offer, average_rating, user_id, store_id, created_at, updated_at)
VALUES ('MacBook Air M3', 'Laptop ultradelgada con chip M3', 1499.99, 8, '/images/products/macbook.jpg', 1, 1, 4.7, 2, 1, NOW(), NOW());

INSERT INTO products (name, description, price, stock, image, category_id, offer, average_rating, user_id, store_id, created_at, updated_at)
VALUES ('AirPods Pro', 'AudÃƒÂ­fonos inalÃƒÂ¡mbricos con cancelaciÃƒÂ³n de ruido', 249.99, 25, '/images/products/airpods.jpg', 1, 0, 4.8, 2, 1, NOW(), NOW());
...
INSERT INTO products (name, description, price, stock, image, category_id, offer, average_rating, user_id, store_id, created_at, updated_at)
VALUES ('Zapatillas Deportivas', 'Zapatillas cÃƒÂ³modas para running', 79.99, 20, '/images/products/zapatillas.jpg', 2, 0, 4.3, 2, 2, NOW(), NOW());
```
...
## Ã°Å¸â€œâ€¹ Script Completo de InserciÃƒÂ³n
...
(9, 'LucÃƒÂ­a Tienda', 'lucia@tienda.com', 2, '12345678', '3168889900', NULL, 1, 'Calle Sur 23', '2025-08-01 02:07:41', '2025-08-01 02:07:41'),
...
(8, 'BaterÃƒÂ­as', NULL, '2025-08-01 03:00:37', '2025-08-01 03:00:37'),
...
(1, 1, 'MotoRÃƒÂ¡pida', 'motorapida', 'logo1.png', 'cover1.jpg', NULL, '#FFA14F', 'Venta de accesorios de motos de alto rendimiento.', '', NULL, 'activa', NULL, '', 0.00, '2025-08-01 02:09:18', '2025-08-01 02:09:18'),
...
(3, 3, 'Repuestos ÃƒÂguila', 'repuestos-aguila', 'logo3.png', 'cover3.jpg', NULL, '#FFA14F', 'Repuestos originales para motos Yamaha y Honda.', '', NULL, 'activa', NULL, '', 0.00, '2025-08-01 02:09:18', '2025-08-01 02:09:18'),
...
(7, 7, 'MecÃƒÂ¡nica Pro', 'mecanica-pro', 'logo7.png', 'cover7.jpg', NULL, '#FFA14F', 'Repuestos y servicio tÃƒÂ©cnico.', '', NULL, 'activa', NULL, '', 0.00, '2025-08-01 02:09:18', '2025-08-01 02:09:18'),
...
(9, 9, 'Accesorios MÃƒÂ³viles', 'accesorios-moviles', 'logo9.png', 'cover9.jpg', NULL, '#FFA14F', 'Accesorios para todo tipo de moto.', '', NULL, 'activa', NULL, '', 0.00, '2025-08-01 02:09:18', '2025-08-01 02:09:18'),
...
(2, 'Aceite Motul 5100', 'Lubricante semisintÃƒÂ©tico 10W40', 58000.00, 50, 'aceite1.jpg', 2, 1, 4.5, 2, 2, '2025-08-01 03:03:25', '2025-08-01 03:03:25'),
...
(1, 1, 'Producto no llegÃƒÂ³ en la fecha estimada.', '2025-07-01 10:00:00', 'email', '2025-08-01 03:22:23', '2025-08-01 03:22:23'),
(2, 2, 'El producto llegÃƒÂ³ daÃƒÂ±ado.', '2025-07-02 11:30:00', 'phone', '2025-08-01 03:22:23', '2025-08-01 03:22:23'),
(3, 3, 'No corresponde con la descripciÃƒÂ³n.', '2025-07-03 14:45:00', 'email', '2025-08-01 03:22:23', '2025-08-01 03:22:23'),
(4, 4, 'Quiero hacer un cambio de producto.', '2025-07-04 09:15:00', 'phone', '2025-08-01 03:22:23', '2025-08-01 03:22:23'),
(5, 5, 'No encuentro opciÃƒÂ³n de reembolso.', '2025-07-05 16:00:00', 'email', '2025-08-01 03:22:23', '2025-08-01 03:22:23'),
(6, 6, 'Necesito soporte tÃƒÂ©cnico urgente.', '2025-07-06 13:20:00', 'email', '2025-08-01 03:22:23', '2025-08-01 03:22:23'),
(7, 7, 'Mi pedido estÃƒÂ¡ incompleto.', '2025-07-07 17:10:00', 'phone', '2025-08-01 03:22:23', '2025-08-01 03:22:23'),
...
(1, 'Cra 10 # 5-30', 'BogotÃƒÂ¡', 'Cundinamarca', '110111', 'Colombia', 4.6097000, -74.0817000, 1, '2025-08-01 17:00:00', '2025-08-01 17:00:00'),
(2, 'Calle 45 # 6-15', 'MedellÃƒÂ­n', 'Antioquia', '050021', 'Colombia', 6.2518000, -75.5636000, 2, '2025-08-01 17:05:00', '2025-08-01 17:05:00'),
(3, 'Av. 3N # 18-24', 'Cali', 'Valle', '760001', 'Colombia', 3.4516000, -76.5320000, 3, '2025-08-01 17:10:00', '2025-08-01 17:10:00'),
(4, 'Cl. 13 # 4-90', 'Barranquilla', 'AtlÃƒÂ¡ntico', '080001', 'Colombia', 10.9685000, -74.7813000, 4, '2025-08-01 17:15:00', '2025-08-01 17:15:00'),
(5, 'Carrera 7 # 8-20', 'Cartagena', 'BolÃƒÂ­var', '130001', 'Colombia', 10.3910000, -75.4794000, 5, '2025-08-01 17:20:00', '2025-08-01 17:20:00'),
(6, 'Cl. 60 # 5-90', 'Pereira', 'Risaralda', '660001', 'Colombia', 4.8143000, -75.6946000, 6, '2025-08-01 17:25:00', '2025-08-01 17:25:00'),
(7, 'Av. 1E # 15-45', 'CÃƒÂºcuta', 'Norte de Santander', '540001', 'Colombia', 7.8939000, -72.5078000, 7, '2025-08-01 17:30:00', '2025-08-01 17:30:00'),
...
(5, 'ActualizaciÃƒÂ³n de perfil', 'Tu perfil fue actualizado correctamente.', 1, 5, '2025-08-01 02:08:07', '2025-08-01 02:08:07'),
(6, 'Tienda aprobada', 'Tu tienda ha sido aprobada por el equipo de revisiÃƒÂ³n.', 1, 6, '2025-08-01 02:08:07', '2025-08-01 02:08:07'),
(7, 'Producto destacado', 'Uno de tus productos ha sido destacado en la portada.', 0, 2, '2025-08-01 02:08:07', '2025-08-01 02:08:07'),
(8, 'Venta realizada', 'Ã‚Â¡Felicidades! Has realizado una venta.', 1, 1, '2025-08-01 02:08:07', '2025-08-01 02:08:07'),
(9, 'Producto agotado', 'Uno de tus productos se ha quedado sin stock.', 0, 3, '2025-08-01 02:08:07', '2025-08-01 02:08:07'),
(10, 'Soporte respondiÃƒÂ³', 'Tu solicitud de soporte ha sido respondida.', 1, 4, '2025-08-01 02:08:07', '2025-08-01 02:08:07');
...
(4, 'admin_mecanico', 'admin.jpg', '1980-11-01', 'Administrador y mecÃƒÂ¡nico', 4, '2025-08-01 03:26:19', '2025-08-01 03:26:19'),
...
## Ã°Å¸â€Â§ Notas TÃƒÂ©cnicas

- **ContraseÃƒÂ±as**: Todas las contraseÃƒÂ±as estÃƒÂ¡n hasheadas con bcrypt. La contraseÃƒÂ±a real para todos los usuarios es `password`.
- **ImÃƒÂ¡genes**: Las rutas de imÃƒÂ¡genes son relativas y deben existir en el directorio `public/images/`.
- **Fechas**: Se usan `NOW()` para fechas actuales y `DATE_SUB(NOW(), INTERVAL X DAY)` para fechas pasadas.
- **IDs**: Los IDs de claves forÃƒÂ¡neas deben coincidir con los registros insertados previamente.
- **Campos opcionales**: Se pueden omitir campos marcados como `nullable` en las migraciones.

## Ã°Å¸Å¡â‚¬ CÃƒÂ³mo Usar
...
Este conjunto de datos proporciona una base sÃƒÂ³lida para probar todas las funcionalidades de ComercioPlus.
