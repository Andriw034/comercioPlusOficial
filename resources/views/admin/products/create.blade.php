        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="mb-6">
                ...
                @if(isset($categories) && $categories->count())
                    ...
                    <p id="catHelp" class="text-xs text-gray-400 mt-2">
                        Si no ves categorías, crea primero la categoría desde tu panel de tienda.
                    </p>
                @else
                    ...
                    <div class="bg-gray-800 border border-gray-700 rounded p-4">
                        ...
                        <a href="{{ route('admin.categories.create') }}"
                           class="inline-block bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-md shadow-sm">
                            Crear categoría
                        </a>
                        <p class="text-xs text-gray-400 mt-2">
                            Las categorías son por tienda — si aún no creaste la tienda, primero créala.
                        </p>
                    </div>
                @endif
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <label for="image" class="inline-flex items-center gap-3 cursor-pointer">
                            ...
                            >
                            <span class="inline-block px-4 py-2 rounded-md bg-white text-gray-900 border border-gray-300 hover:bg-gray-100 text-sm font-medium">
                                Elegir archivo
                            </span>
                        ...
                        <div class="mt-2">
                            <p id="imgHelp" class="text-sm text-gray-400">Formatos permitidos: JPG, PNG, GIF, WEBP. Tamaño máximo: 2MB.</p>
                        ...
                        {{-- URL remota opcional --}}
                        <div class="mt-4">
                            <label for="image_url" class="block text-sm font-semibold text-gray-200 mb-2">o URL de imagen remota (opcional)</label>
                            <input
                                type="url"
                                name="image_url"
                                id="image_url"
                                ...
                                class="w-full px-4 py-3 bg-white text-gray-900 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-orange-400 placeholder-gray-500 @error('image_url') ring-red-400 border-red-400 @enderror transition-all"
                                inputmode="url"
                            >
                            <p class="text-xs text-gray-500 mt-1">
                                Si cargas archivo y también pegas URL, se usará el archivo subido.
                            </p>
                            @error('image_url')
                                <p class="text-red-400 text-sm mt-2 font-medium" role="alert">{{ $message }}</p>
                            @enderror
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Mejor accesibilidad: tecla Enter/Espacio en el label activa el input file
