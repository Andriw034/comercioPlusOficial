    ...
    <div class="bg-white/10 ring-1 ring-white/15 rounded-3xl p-6">
        ...
        <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <input type="number" step="0.01" name="price" id="price" placeholder="Precio del producto" class="w-full px-4 py-2 bg-white border border-gray-300 rounded-xl text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-orange-500 smooth" value="{{ old('price', $product->price) }}" required>
            </div>
            <div>
