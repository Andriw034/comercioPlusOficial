    ...
    <div class="min-h-screen flex">
        ...
        <aside class="w-64 bg-gray-800 border-r border-gray-700 p-4">
            ...
            <nav class="space-y-1">
                ...
                {{-- Ver tienda --}}
                @if(auth()->user()->store)
                    <a href="{{ route('storefront.public.home', auth()->user()->store->slug) }}" target="_blank" class="flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-300 hover:bg-gray-700 hover:text-white transition">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
