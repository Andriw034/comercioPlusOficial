...
use App\Http\Controllers\Api\Payment\MercadoPagoController;
...
Route::get('/health', function () {
    return response()->json([
        ...
        'importer_version' => InventoryImportService::IMPORTER_VERSION,
...
// MercadoPago payment routes (public — webhook must be CSRF-exempt).
Route::prefix('payments')->group(function () {
    ...
    Route::get('/result',             [MercadoPagoController::class, 'result']);
});
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::delete('/merchant/customers/{customer}', [CustomerController::class, 'destroy']);
